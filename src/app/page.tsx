    ...
    <>
      <MaxWidthWrapper className=" mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className=" mt-5 max-w-prose text-zinc-700 sm:text-lg">
          AskFiles allows to convey your questions with the content provided in
          the uploaded file. Simply upload the files and ask questions right
          away.
        </p>
        <Link
        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffbb80] to-[#e61313] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
          {/* saas image  */}
          <div>
        ...
        <ol className=" my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0 ">
          <li className=" md:flex-1">
            <div className=" flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2  md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className=" mt-2 text-zinc-700">
                Either starting with a free plan or a{" "}
          ...
          <li className=" md:flex-1">
            <div className=" flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2  md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className=" mt-2 text-zinc-700">
                It&apos;s that simple . Try out today . It really takes less
                than a minute.
              </span>
            </div>
          </li>
